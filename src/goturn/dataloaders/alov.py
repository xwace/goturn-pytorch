...
try:
    import sys
    sys.path.append("/home/star/Desktop/goturn-pytorch/src/goturn/helper")
    sys.path.append("/home/star/Desktop/goturn-pytorch/src/goturn/dataloaders")
    ...
    logger.error('ALOV Please run $source settings.sh from root directory')
    sys.exit(1)
